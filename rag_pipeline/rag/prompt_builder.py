...
JSON_SPEC_SYSTEM_PROMPT = (
    ...
    "RULES:\n"
    "1. Extract ONLY values that ARE PRESENT in the context.\n"
    "2. If a parameter has only a 'Value', put it in 'value' and leave 'limit_type' empty.\n"
    "3. Do NOT invent 'max', 'min' or 'typical' if they are not explicitly labeled in the table.\n"
    "4. Preserve symbols (ID, VGS, etc.) exactly.\n"
